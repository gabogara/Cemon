...
<div class="container">
		...
		<?php
			if (isset($_POST['monitorear'])) {
				...
				//-------------------server1-------------------------				
				$wsdl = "http://localhost/Comercio/servidores/server1.php?wsdl";
				...
				//-------------------server2-------------------------				
				$wsdl = "http://localhost/Comercio/servidores/server2.php?wsdl";
				$name2='Base de Datos';
				// Create client object
				$client = new nusoap_client($wsdl, 'wsdl');
				$err = $client->getError();
				...
				//-------------------server3-------------------------				
				$wsdl = "http://localhost/Comercio/servidores/server3.php?wsdl";
				$name3='Aplicación';
				// Create client object
				$client = new nusoap_client($wsdl, 'wsdl');
				$err = $client->getError();
				...
				//-------------------server4-------------------------				
				$wsdl = "http://localhost/Comercio/servidores/server4.php?wsdl";
				$name4='Aplicación';
				// Create client object
				$client = new nusoap_client($wsdl, 'wsdl');
				$err = $client->getError();
				...
				//-------------------server5-------------------------				
				$wsdl = "http://localhost/Comercio/servidores/server5.php?wsdl";
